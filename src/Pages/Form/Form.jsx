...
function Form() {
  ...
  const { title, remplaire, name, email, Number, date, send } = t("Form");
  function SubmitForm(e) {
    e.preventDefault();
    alert("Vous avez envoyé la Form avec success");
  }
  return (
    <section id="form" className="bg-gray-800 text-gray-100 px-8 py-12">
      <div>
        <div className="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div className="text-gray-700 mt-8">{remplaire}</div>
            </div>
